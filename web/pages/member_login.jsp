          ...
          <div class="col-lg-8 offset-lg-2">
            <div class="basic-login">
              ...
              <form action="<%=loginUrl%>" method="post">
                <label for="name">帐号名称 <span>**</span></label>
                <input id="name" type="text" name="mid" placeholder="帐号名称" />
                <label for="pass">帐号密码 <span>**</span></label>
                <input id="pass" type="password" name="password" placeholder="帐号密码" />
                <div class="login-action mb-20 fix">
                                    <span class="log-rem f-left">
                                        <input id="remember" type="checkbox" name="rememberMe" id="rememberMe" value="7776000"/>
                                        <label for="remember">Remember me!</label>
                                    </span>
                </div>
                <button class="os-btn w-100" type="submit">Login Now</button>
                <div class="or-divide"><span>or</span></div>
                <a href="pages/member_regist.jsp" class="os-btn os-btn-black w-100">Register Now</a>
              </form>
            </div>
          </div>
        </div>
