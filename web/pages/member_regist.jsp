...
<%
  ...
  String basePath = request.getScheme() + "://"
          ...
          + path + "/";
  String regisUrl = basePath + "/pages/MemberServletFront/regist";
%>
            ...
            <div class="main-menu d-none d-lg-block">
              <nav>
                <ul>
                  ...
                  <li><a href="<%=basePath%>/pages/front/commodity/CommodityServletFront/list">商品列表</a></li>
      ...
      <div class="row">
        <div class="col-lg-8 offset-lg-2">
          <div class="basic-login">
            ...
            <form action="<%=regisUrl%>" method="post">
              <label for="name">用户名 <span>**</span></label>
              <input id="name" type="text" name="mid" placeholder="用户名" />
              ...
              <a href="<%=basePath%>/pages/member_login.jsp" class="os-btn os-btn-black w-100">login Now</a>
            </form>
          </div>
        </div>
      </div>
