...
<%
    ...
    String basePath = request.getScheme() + "://"
            ...
            + path + "/";
    String insertUrl = basePath + "/pages/back/admin/commodity/CommodityServletBack/insert";
%>
<html>
<head>
    <base href="<%=basePath%>">
    ...
    <form action="<%=insertUrl%>" method="post" onsubmit="return validateInsert()" enctype="multipart/form-data">
        <table border="1" cellpadding="5" cellspacing="0" bgcolor="F2F2F2">
            ...
            <tr onmouseover="changeColor(this,'white')" onmouseout="changeColor(this,'F2F2F2')">
                ...
                <td rowspan="7"><div id="preview"></div></td>
            </tr>
            <tr onmouseover="changeColor(this,'white')" onmouseout="changeColor(this,'F2F2F2')">
                <td>商品类型：</td>
                <td>
                    <c:if test="${allGenre != null}" var="res">
                        <select name="gid" id="gid">
                            <c:forEach items="${allGenre}" var="genre">
                                <option value="${genre.gid}">${genre.title}</option>
                            </c:forEach>
                        </select>
                    </c:if>
                </td>
            ...
            <tr onmouseover="changeColor(this,'white')" onmouseout="changeColor(this,'F2F2F2')">
                <td>发布状态：</td>
                <td>
                    <input type="radio" name="status" id="status0" checked class="init" value="0">下架
                    <input type="radio" name="status" id="status1" class="init" value="1">上架
                </td>
